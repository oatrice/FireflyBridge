                            ...
                            {formData.numbers?.map((num, index) => (
                                <div key={num.id} className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-2 rounded-lg border border-neutral-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-neutral-900 placeholder-neutral-500"
